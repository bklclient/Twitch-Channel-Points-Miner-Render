...
twitch_miner = TwitchChannelPointsMiner(
    ...
    logger_settings=LoggerSettings(
        ...
        discord=Discord(
            webhook_api="https://canary.discord.com/api/webhooks/1238641313054855309/2cY4Ir2DZz-rznaJXOdAw1O4dPxIrAJ9kHURRYVOTVz1-Sxg362A45hVJVa73cdb7pgt",  # Discord Webhook URL
            events=[Events.STREAMER_ONLINE, Events.STREAMER_OFFLINE,
                    Events.GAIN_FOR_WATCH, Events.GAIN_FOR_CLAIM, Events.BET_WIN, Events.BET_LOSE, Events.GAIN_FOR_WATCH_STREAK],                                  # Only these events will be sent to the chat
        ),
        matrix=Matrix(
...
# You can customize the settings for each S If not settings were provided, the script would use the streamer_settings from TwitchChannelPointsMiner.
...
twitch_miner.mine(
    [
       Streamer("TheRicch", settings=StreamerSettings(make_predictions=True  , follow_raid=True , claim_drops=True  , watch_streak=True , )
